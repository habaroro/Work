...
import imgImage1 from "../assets/f228563ccb35d67e292f2f51ac565a95625dbd08.png";
import imgImage2 from "../assets/d6b8f0c107beec31d7b38ccf4d2ff22c032ca274.png";
import imgImage3 from "../assets/71f3945ce5afe5962d1e0b2a71e03034747ed047.png";
import imgImage4 from "../assets/2897bb468ae95606199d27545adf92fcf2a52a41.png";
import imgImage5 from "../assets/b9ae1985fdde75a9c854873abd3c3c8ebd9e949a.png";
...
const TRACKS = [
  ...
  },
  {
    ...
    audio: '/music/4.mp3',
    duration: '3:00',
    lyrics: "퍼펙트 문해~퍼펙트 문해~퍼펙트 문해~퍼펙트 문해\n초등 문해력 키우기 읽기 유창성, 독해 전략\n어휘력을 중심으로 설계\n공부가 쉬워지는\n퍼펙트 문해 퍼펙트 문해 퍼펙트 문해 퍼펙트 문해\n52권의 단계별 도서\n전문 교사의 화상 관리\n문해력의 완벽한 세계\n공부가 쉬워지는\n퍼펙트 문해~퍼펙트 문해~퍼펙트 문해~퍼펙트 문해"
  },
  {
    id: '5',
    title: 'No.5',
    ...
    <div className="min-h-screen bg-[#f9fafb] dark:bg-black font-sans text-foreground selection:bg-black/10">
      ...
      <header className="sticky top-0 z-10 w-full bg-white/80 dark:bg-black/80 backdrop-blur-xl border-b border-[rgba(229,231,235,0.5)] dark:border-white/10">
        <div className="mx-auto max-w-md px-6 py-4 flex items-center justify-between h-[80px]">
          <div>
            <h1 className="text-[24px] font-bold tracking-[-0.5px] text-[#0a0a0a] dark:text-white leading-8">퍼펙트 문해 로고송</h1>
