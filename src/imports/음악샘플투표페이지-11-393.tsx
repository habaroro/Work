import svgPaths from "./svg-05p2zyxspp";
import imgImageNo1 from "figma:asset/f228563ccb35d67e292f2f51ac565a95625dbd08.png";
import imgImageNo2 from "figma:asset/d6b8f0c107beec31d7b38ccf4d2ff22c032ca274.png";
import imgImageNo3 from "figma:asset/71f3945ce5afe5962d1e0b2a71e03034747ed047.png";
import imgImageNo4 from "figma:asset/2897bb468ae95606199d27545adf92fcf2a52a41.png";
import imgImageNo5 from "figma:asset/b9ae1985fdde75a9c854873abd3c3c8ebd9e949a.png";
...
function ImageNo() {
  return (
    <div className="h-[64px] relative shrink-0 w-full" data-name="Image (No.1)">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[123.99%] left-[9.37%] max-w-none top-[4.69%] w-[82.06%]" src={imgImageNo1} />
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="absolute bg-[#f3f4f6] content-stretch flex flex-col items-start left-[12px] overflow-clip rounded-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] size-[64px] top-[12px]" data-name="Container">
      <ImageNo />
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[14.4px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3999 14.4">
        <g id="Icon">
          <g id="Vector" />
        </g>
      </svg>
...
function Button1() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[364.6px] p-px rounded-[16777200px] size-[28.8px] top-[30.6px]" data-name="Button">
...
function ImageNo1() {
  return (
    <div className="h-[64px] relative shrink-0 w-full" data-name="Image (No.2)">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[89.06%] left-[7.3%] max-w-none top-[5.47%] w-[92.75%]" src={imgImageNo2} />
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute bg-[#f3f4f6] content-stretch flex flex-col items-start left-[13px] overflow-clip rounded-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] size-[64px] top-[13px]" data-name="Container">
      <ImageNo1 />
    </div>
  );
}
...
function ImageNo2() {
  return (
    <div className="h-[64px] relative shrink-0 w-full" data-name="Image (No.3)">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[106.07%] left-[10.16%] max-w-none top-[5.82%] w-[81.25%]" src={imgImageNo3} />
      </div>
    </div>
  );
}
...
function ImageNo3() {
  return (
    <div className="h-[64px] relative shrink-0 w-full" data-name="Image (No.4)">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[102.89%] left-[5.47%] max-w-none top-[6.8%] w-[89.84%]" src={imgImageNo4} />
      </div>
    </div>
  );
}
...
function ImageNo4() {
  return (
    <div className="h-[64px] relative shrink-0 w-full" data-name="Image (No.5)">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[119.49%] left-[9.38%] max-w-none top-[5.87%] w-[81.25%]" src={imgImageNo5} />
      </div>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[32px] left-0 not-italic text-[#0a0a0a] text-[24px] top-0 tracking-[-0.5297px]">퍼펙트문해 LOGO SONG</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[16px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[16px] left-0 not-italic text-[#717182] text-[12px] top-px tracking-[0.6px] uppercase">마음에 드는 CM송에 투표해주세요.</p>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="h-[48px] relative shrink-0 w-[240.641px]" data-name="Container">
